...
class ManagersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'Managers_fk0' => ['type' => 'index', 'columns' => ['customer_id'], 'length' => []],
            'Managers_fk1' => ['type' => 'index', 'columns' => ['hotel_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'username' => ['type' => 'unique', 'columns' => ['username'], 'length' => []],
            'Managers_fk0' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'Managers_fk1' => ['type' => 'foreign', 'columns' => ['hotel_id'], 'references' => ['hotels', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
