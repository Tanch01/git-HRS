...
class AdminController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Managers', 'Customers', 'Hotels']
        ];
    ...
    public function add()
    {
        ...
        $managers = $this->Admin->Managers->find('list', ['limit' => 200]);
        $customers = $this->Admin->Customers->find('list', ['limit' => 200]);
        $hotels = $this->Admin->Hotels->find('list', ['limit' => 200]);
        $this->set(compact('admin', 'managers', 'customers', 'hotels'));
    }
